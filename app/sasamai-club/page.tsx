...
export const metadata: Metadata = {
  title: '笹米クラブ | 川西市笹部の米づくり',
  description: '笹部の棚田を守る米づくりの実践。土づくりから収穫まで、里山の営みを一緒に体験しませんか。Sasabaseの活動として笹部の景観と農業文化を次世代へつなぎます。',
}
...
const seasons = [
  ...
  },
  {
    ...
    title: '稲刈り・収穫',
    description:
      '稲刈りの大部分はコンバインで行います。機械が入れない場所など、一部を手で刈ることもあります。脱穀・乾燥を経て「新米」として仕上がります。Sasabaseでは外の釜戸で羽釜ご飯を炊いて楽しむこともできます。',
  },
]

export default function SasamaiClubPage() {
  return (
    <>
      {/* Hero */}
        ...
        <div className="container-base">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div>
              ...
              <h1 className="heading-serif text-h1 text-foreground mb-4 tracking-jp">
                笹米クラブ
              </h1>
      ...
      <section id="sasamai" className="section-padding bg-stone-50 border-t border-border scroll-mt-[68px]">
        <div className="container-base">
          <div className="mb-12">
            ...
            <p className="text-sm text-stone-500 leading-jp tracking-jp max-w-[44ch] mb-3">
              土づくりから始まり、田植え・水管理・収穫まで。
              季節ごとに異なる作業が続きます。
            </p>
            <p className="text-xs text-stone-400 leading-jp tracking-jp">
              ※ 実際に参加できる作業や日程は、天候・田んぼの状態・受け入れ状況によって変わります。
            </p>
          </div>
