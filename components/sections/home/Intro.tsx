    ...
    <section className="py-10 md:py-16 lg:py-20 border-t border-border">
      <div className="container-base">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-14 items-center">
          ...
          {/* Text */}
          <div>
            <p className="text-xs font-medium tracking-label text-muted mb-5">Sasabaseについて</p>

            <h2 className="heading-serif text-h1 text-balance text-foreground mb-5 leading-[1.4]">
              地域は、学びの宝庫です。
            </h2>

            <p className="text-base md:text-lg text-stone-500 leading-jp tracking-jp mb-7 max-w-[32ch]">
              Sasabaseは、<br />
              教育 × 地域 × ビジネスをつなぐ<br />
              実験型の学びの場です。
            </p>
